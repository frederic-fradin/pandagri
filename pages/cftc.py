...
with tab1:
    ...
    sel_market = col3.multiselect(
        label="Market", options=dict_com_disagg["CFTC_Market_Code"]
    )
    sel_date = col3.date_input(
        label="Report date", format="YYYY-MM-DD", value=last_report_date
    )
